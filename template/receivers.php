          ...
          <div class="col-sm-12">
            <div class="card">
              <div class="card-header d-flex justify-content-between align-items-center">
                <h4>All Receivers</h4>
                <button class="btn btn-primary" type="button" data-bs-toggle="modal" data-bs-target="#receiverModal">
                  ...
                  <table class="display" id="basic-1">
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td>9988776655</td>
                        <td class="text-truncate" style="max-width: 250px;">12B, Karol Bagh, Delhi - 110005</td>
                        <td><span class="badge badge-light-primary">Wings Tech</span></td>
                        <td>
                          <ul class="action">
                            <li class="edit"> <a href="#" data-bs-toggle="modal" data-bs-target="#receiverModal" class="bg-warning-light"><i class="icofont icofont-edit text-warning"></i></a></li>
                      ...
                      <tr>
                        ...
                        <td>+1-555-0199</td>
                        <td class="text-truncate" style="max-width: 250px;">5th Avenue, New York, USA, 10001</td>
                      ...
                      <tr>
                        ...
                        <td>8877665544</td>
                        <td class="text-truncate" style="max-width: 250px;">78, MG Road, Bangalore - 560001</td>
