          ...
          <div class="col-sm-12">
            <div class="card">
              <div class="card-header d-flex justify-content-between align-items-center">
                ...
                <button class="btn btn-primary" type="button" data-bs-toggle="modal" data-bs-target="#addBarcodeModal">
                  ...
                  <table class="display" id="basic-1">
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td>
                          <ul class="action">
                            <li class="edit"> <a href="#" data-bs-toggle="modal" data-bs-target="#addBarcodeModal" class="bg-warning-light"><i class="icofont icofont-edit text-warning"></i></a></li>
