          ...
          <div class="col-sm-12">
            <div class="card">
              <div class="card-header d-flex justify-content-between align-items-center">
                ...
                <button class="btn btn-primary" type="button" data-bs-toggle="modal" data-bs-target="#complaintModal">
                  ...
                  <div class="p-3 rounded bg-primary-light">
                    <div class="row g-3">
                      ...
                      <div class="col-md-4">
                        ...
                        <input class="form-control" type="text" placeholder="AWB No., Phone, or Client Name">
                      </div>
                  ...
                  <table class="display" id="basic-1">
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td><span class="text-danger f-w-700 font-roboto"><i class="icofont icofont-brand-designbump"></i> URGENT</span>
                        </td>
                        <td><span class="badge badge-light-danger">Open</span></td>
                        <td>
                          <ul class="action">
                            <li class="edit"> <a href="#" data-bs-toggle="modal" data-bs-target="#complaintModal" class="bg-warning-light"><i class="icofont icofont-edit text-warning"></i></a></li>
                      ...
                      <tr>
                        ...
                        <td><span class="text-warning f-w-700 font-roboto"><i class="icofont icofont-brand-designbump"></i> HIGH</span></td>
                      ...
                      <tr>
                        ...
                        <td><span class="text-info f-w-700 font-roboto"><i class="icofont icofont-brand-designbump"></i> MEDIUM</span></td>
                ...
                <div class="modal-body">
                  <div class="row g-3">
                    ...
                    <div class="col-12">
                      ...
                      <textarea class="form-control" rows="4" placeholder="Enter exactly what the customer reported..."
                        required=""></textarea>
                    </div>
                    <div class="col-12">
                      <hr class="mt-2 mb-2">
