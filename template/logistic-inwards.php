          ...
          <div class="col-sm-12">
            <div class="card">
              <div class="card-header d-flex justify-content-between align-items-center">
                ...
                <button class="btn btn-primary" type="button" data-bs-toggle="modal" data-bs-target="#addInwardModal">
              ...
              <div class="card-body">
                <div class="head-options d-flex gap-2 mb-3">
                  ...
                  <button class="btn btn-outline-primary" type="button" data-bs-toggle="modal" data-bs-target="#deliveryTeamModal">
                    <i class="fa fa-users me-0 me-md-2"></i><span class="d-none d-md-inline">Delivery Team</span>
                  </button>
                  ...
                  <table class="display" id="basic-1">
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td>
                          <ul class="action">
                            <li class="edit"> <a href="#" data-bs-toggle="modal" data-bs-target="#addInwardModal" class="bg-warning-light"><i class="icofont icofont-edit text-warning"></i></a></li>
                ...
                <div class="modal-body">
                  <div class="row g-3">
                    ...
                    <div class="col-md-12">
                      ...
                      <input class="form-control f-w-700 border-primary" type="text" placeholder="Scan here..."
                        required>
                    </div>
                    <div class="col-md-6">
