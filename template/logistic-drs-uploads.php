          ...
          <div class="col-sm-12">
            <div class="card">
              <div class="card-header d-flex justify-content-between align-items-center">
                <h5>DRS Records</h5>
                <button class="btn btn-primary" type="button" data-bs-toggle="modal" data-bs-target="#uploadDrsModal">
                  ...
                  <table class="display" id="basic-1">
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td>DIPESH CHAVDA</td>
                        <td>
                          <a href="javascript:void(0)" data-bs-toggle="modal" data-bs-target="#imagePreviewModal">
                        ...
                        <td>
                          <ul class="action">
                            <li class="edit"> <a href="#" data-bs-toggle="modal" data-bs-target="#uploadDrsModal" class="bg-warning-light"><i class="icofont icofont-edit text-warning"></i></a></li>
        ...
        <div class="modal-dialog modal-xl modal-dialog-centered" role="document">
          <div class="modal-content border-0 bg-transparent">
            ...
            <div class="modal-body p-0 text-center">
              <img src="assets/images/dashboard/widget-bg.png" class="img-fluid rounded shadow-lg"
