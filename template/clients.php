                  ...
                  <table class="display" id="basic-1">
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td>
                          <ul class="action">
                            <li class="edit"> <a href="#" data-bs-toggle="modal" data-bs-target="#clientModal" class="bg-warning-light"><i class="icofont icofont-edit text-warning"></i></a></li>
                ...
                <div class="modal-body pb-0">
                  <div class="row g-3">
                    <div class="col-md-6">
                      ...
                      <input class="form-control" type="text" placeholder="e.g. Global Exports Inc." required="">
                    </div>
                    <div class="col-md-6">
                    ...
                    <div class="col-md-3">
                      ...
                      <div class="d-flex gap-3 pt-2">
                        <div class="form-check radio radio-primary">
                          <input class="form-check-input" id="gst1" type="radio" name="gstType" value="gst" checked>
                          <label class="form-check-label" for="gst1">GST</label>
                        </div>
                        <div class="form-check radio radio-primary">
                          <input class="form-check-input" id="gst2" type="radio" name="gstType" value="non-gst">
