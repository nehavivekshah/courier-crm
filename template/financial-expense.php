                  ...
                  <table class="display" id="basic-1">
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td>
                          <ul class="action">
                            <li class="edit"> <a href="#" data-bs-toggle="modal" data-bs-target="#addExpenseModal" class="bg-warning-light"><i class="icofont icofont-edit text-warning"></i></a></li>
                ...
                <div class="modal-body">
                  <div class="row g-3">
                    ...
                    <div class="col-md-12">
                      ...
                      <input class="form-control" type="text" placeholder="e.g. Landlord name, Petrol Pump, Staff Name"
                        required="">
                    </div>
                    <div class="col-md-6">
                      <label class="form-label">Category</label>
                    ...
                    <div class="col-12">
                      ...
                      <textarea class="form-control" rows="2" placeholder="Describe the reason for expense"></textarea>
                    </div>
                  </div>
                </div>
              </form>
