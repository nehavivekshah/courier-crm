...
@section('title', 'Carriers - Courier Management System')
                ...
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        ...
                        <button class="btn btn-primary" type="button" data-bs-toggle="modal" data-bs-target="#UpdateModal">
                            <i class="fa fa-plus me-2"></i>Add New Carrier
                        </button>
                    </div>
                    <div class="card-body">
                    ...
                    <form class="needs-validation" novalidate="">
                        <div class="row g-3">
                            <div class="col-md-12">
                                ...
                                <input class="form-control" type="text" placeholder="e.g. DTDC" required="">
                            </div>
                            <div class="col-md-12">
                                <label class="form-label">Prefix</label>
                                <input class="form-control" type="text" placeholder="e.g. D" required="">
                            </div>
                            <div class="col-md-12">
