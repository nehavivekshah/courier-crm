...
@section('title', 'Centers - Courier Management System')
                        ...
                        <div class="table-responsive custom-scrollbar">
                            <table class="display" id="basic-1">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td class="f-w-600">Ahmedabad HO</td>
                                        <td>Ahmedabad</td>
                                        <td>Gujarat</td>
                                        <td>
                                            <ul class="action">
                    ...
                    <form class="needs-validation" novalidate="">
                        <div class="row g-3">
                            <div class="col-md-12">
                                ...
                                <input class="form-control" type="text" placeholder="e.g. Center Name" required="">
                            </div>
                            <div class="col-md-12">
                                <label class="form-label">City</label>
                                <input class="form-control" type="text" placeholder="e.g. Mumbai" required="">
                            </div>
                            <div class="col-md-12">
                                <label class="form-label">State</label>
                                <input class="form-control" type="text" placeholder="e.g. Maharashtra" required="">
                            </div>
                        </div>
                    </form>
                </div>
