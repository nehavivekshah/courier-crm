...
@section('title', 'Profile - Courier Management System')
                    ...
                    <form class="card">
                        ...
                        <div class="card-footer text-end">
                            <button class="btn btn-primary" type="button" data-bs-toggle="modal"
                                data-bs-target="#exampleModalCenter1">Update Profile</button>
                        </div>
                    </form>
                </div>
            </div>
            ...
            <div class="modal-content">
                <div class="modal-body">
                    <div class="modal-toggle-wrapper">
                        ...
                        <h4 class="text-center pb-2">Success! Profile Updated.</h4>
