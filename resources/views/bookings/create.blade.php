...
@section('title', 'Add New Booking - Courier Management System')
...
@section('content')
                    ...
                    <div class="card-body">
                        <div class="shopping-wizard g-5">
                            <div class="shipping-form">
                                <div class="nav nav-pills horizontal-options shipping-options" id="booking-wizard-tab"
                                    role="tablist">
                                    <a class="nav-link active" id="step-setup-tab" data-bs-toggle="pill" href="#step-setup"
                                        role="tab">
                                    ...
                                    <a class="nav-link" id="step-contacts-tab" data-bs-toggle="pill" href="#step-contacts"
                                        role="tab">
                                        <div class="cart-options">
                                    ...
                                    <a class="nav-link" id="step-parcel-tab" data-bs-toggle="pill" href="#step-parcel"
                                        role="tab">
                                        <div class="cart-options">
                                    ...
                                    <a class="nav-link" id="step-billing-tab" data-bs-toggle="pill" href="#step-billing"
                                        role="tab">
                                        <div class="cart-options">
                                        ...
                                        <div class="row g-3">
                                            <div class="col-md-6">
                                                ...
                                                <div class="form-check radio radio-primary ps-0 select-booking-type">
                                                    <ul class="radio-wrapper justify-content-start">
                                                        <li>
                                                            <input class="form-check-input" id="typeSurface" type="radio"
                                                                name="booking_type" value="Surface" checked>
                                                            <label class="form-check-label mb-0" for="typeSurface"><i
                                                                    class="fa fa-truck"></i><span>Surface</span></label>
                                                        </li>
                                                        <li>
                                                            <input class="form-check-input" id="typeAir" type="radio"
                                                                name="booking_type" value="Air">
                                                            <label class="form-check-label mb-0" for="typeAir"><i
                                                                    class="fa fa-plane"></i><span>Air</span></label>
                                                        </li>
                                                        <li>
                                                            <input class="form-check-input" id="typeCargo" type="radio"
                                                                name="booking_type" value="Cargo">
                                                            <label class="form-check-label mb-0" for="typeCargo"><i
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="form-check radio radio-primary ps-0 select-customer-mode">
                                                    <ul class="radio-wrapper justify-content-start">
                                                        <li>
                                                            <input class="form-check-input" id="modeAccount" type="radio"
                                                                name="customer_mode" value="Account">
                                                            <label class="form-check-label mb-0" for="modeAccount"><i
                                                                    class="fa fa-university"></i><span>Account</span></label>
                                                        </li>
                                                        <li>
                                                            <input class="form-check-input" id="modeCash" type="radio"
                                                                name="customer_mode" value="Cash" checked>
                                                            <label class="form-check-label mb-0" for="modeCash"><i
                                        ...
                                        <div class="row g-3">
                                            <div class="col-md-6 typeahead typeahead-wrapper">
                                                <div class="bg-primary-light rounded p-3 h-100">
                                                    ...
                                                    <div id="sender-account-group" class="theme-form" style="display:none;">
                                                        <div id="client-search-box">
                                                            ...
                                                            <div class="input-group">
                                                                ...
                                                                <span class="input-group-text list-light-primary"
                                                                    id="btn-add-client-fields" style="cursor:pointer;">
                                                                    <i class="icofont icofont-ui-add txt-primary"></i>
                                                                </span>
                                                            </div>
                                                        </div>
                                                        <div id="client-manual-fields" style="display:none;">
                                                            <div class="row g-2">
                                                                ...
                                                                <div class="col-md-6"><label class="form-label">Client
                                                                        Name</label><input type="text"
                                                                        class="form-control mb-2"></div>
                                                                <div class="col-md-6"><label class="form-label">Client
                                                                        Mobile</label><input type="tel"
                                                                        class="form-control mb-2"></div>
                                                                <div class="col-md-6"><label class="form-label">Client Proof
                                                                        ID</label>
                                                    ...
                                                    <div id="receiver-account-group" class="theme-form"
                                                        ...
                                                        <div id="receiver-search-box">
                                                            ...
                                                            <div class="input-group">
                                                                ...
                                                                <span class="input-group-text list-light-primary"
                                                                    id="btn-add-receiver-fields" style="cursor:pointer;">
                                                                    <i class="icofont icofont-ui-add txt-primary"></i>
                                                                </span>
                                                            </div>
                                                        </div>
                                        ...
                                        <div class="billing-form-wrapper">
                                            <div class="row g-3">
                                                ...
                                                <div class="col-12 mt-4 d-flex justify-content-between">
                                                    <button class="btn btn-secondary prev-step">Back</button>
                                                    <button class="btn btn-success px-5 py-2 f-w-700" data-bs-toggle="modal"
            ...
            <div class="modal-content">
                <div class="modal-body">
                    <div class="modal-toggle-wrapper">
                        <ul class="modal-img">
                            <li> <img src="{{ asset('assets/images/gif/dashboard-8/successful.gif') }}" alt="popper"></li>
                        </ul>
    ...
    <!-- Includes print modal or other partials if needed -->
