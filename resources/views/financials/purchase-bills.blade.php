...
@section('title', 'Purchase Bills - Courier Management System')
...
@section('content')
                                        ...
                                        <td>
                                            <ul class="action">
                                                <li class="edit"> <a href="#" data-bs-toggle="modal"
                                                        data-bs-target="#addPurchaseModal" class="bg-wraning-light"><i
    ...
    <!-- Modal: Add/Update Purchase Bill -->
                        ...
                        <div class="modal-body">
                            <div class="row g-3">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input class="form-control bg-light" type="number" step="0.01" placeholder="0.00"
                                        readonly>
                                </div>
                                <div class="col-md-12">
                                    <label class="form-label">Payment Status</label>
                                    <div class="d-flex gap-4 pt-1">
                                        <div class="form-check radio radio-primary">
                                            <input class="form-check-input" id="pb1" type="radio" name="pbStatus"
                                                value="Paid">
                                            <label class="form-check-label" for="pb1">Paid</label>
                                        </div>
                                        <div class="form-check radio radio-primary">
                                            <input class="form-check-input" id="pb2" type="radio" name="pbStatus"
                                                value="Unpaid" checked>
                                            <label class="form-check-label" for="pb2">Unpaid</label>
                                        </div>
                                        <div class="form-check radio radio-primary">
                                            <input class="form-check-input" id="pb3" type="radio" name="pbStatus"
                                                value="Partial">
