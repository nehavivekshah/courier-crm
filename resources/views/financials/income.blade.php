...
@section('title', 'Income - Courier Management System')
                                        ...
                                        <td>
                                            <ul class="action">
                                                <li class="edit"> <a href="#" data-bs-toggle="modal"
                                                        data-bs-target="#addIncomeModal" class="bg-warning-light"><i
                        ...
                        <div class="modal-body">
                            <div class="row g-3">
                                ...
                                <div class="col-12">
                                    ...
                                    <input class="form-control" type="text" placeholder="e.g. Scrap Sale or Client Name"
                                        required="">
                                </div>
                                <div class="col-md-6">
                                    <label class="form-label">Category</label>
