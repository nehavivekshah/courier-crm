...
@section('title', 'Customer Enquiries - Courier Management System')
                                ...
                                <div class="row g-3">
                                    <div class="col-md-4">
                                        ...
                                        <input class="form-control" type="text"
                                            placeholder="Search by name, phone or AWB...">
                                    </div>
                                    <div class="col-md-3">
                                        ...
                                        <td>
                                            <ul class="action">
                                                <li class="edit"> <a href="#" data-bs-toggle="modal"
                                                        data-bs-target="#inquiryModal" class="bg-warning-light"><i
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-12">
                                    ...
                                    <textarea class="form-control" rows="4"
                                        placeholder="Describe the customer's request in detail..." required=""></textarea>
                                </div>
                                <div class="col-12">
